...
public class FlutterFirebaseMessagingPlugin
  ...
  public void onMethodCall(final MethodCall call, @NonNull final Result result) {
    ...
    if(call.method.equals("setCookie")){
      SharedPreferences preferences = mainActivity.getApplicationContext().getSharedPreferences("session",mainActivity.getApplication().MODE_PRIVATE);
      final SharedPreferences.Editor editor =  preferences.edit();
      editor.putString("cookie",call.arguments.toString());
